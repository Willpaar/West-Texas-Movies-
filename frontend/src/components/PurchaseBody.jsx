...
export default function PurchaseBody({ movie }) {
  ...
  const handlePurchase = async () => {
    if (
      ...
      alert(
        'Please enter a valid 16-digit card number, 3-digit CVV, and select month/year.'
      );
      return;
    }
  ...
  return (
    <div className="PurchaseBody">
      <h1>
        Purchase Tickets to see {movie.title} on {movie.date} {movieTime} in{' '}
        {movie.location}
      </h1>
        ...
        <div className="rightCont">
          ...
          <div className="cartCont">
            ...
            {[...Array(ticketCount)].map((_, idx) => (
              <p key={idx}>Ticket for {movie.title} = $10.00</p>
            ))}
